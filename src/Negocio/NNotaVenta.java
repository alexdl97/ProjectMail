...
public class NNotaVenta {
    ...
    public int registrar(String codigo, Date fecha_emision, double monto_total, String estado, int pedidoid) {
        notaventa = new DNotaVenta(codigo, fecha_emision, monto_total, estado, pedidoid);
