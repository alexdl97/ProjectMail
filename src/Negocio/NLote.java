...
public class NLote {
    ...
    public int registrar(String codigo, Date fecha_ingreso, int cantidad, String estado, int almacenid, int proveedorid) {
        lote = new DLote(codigo, fecha_ingreso, cantidad, estado, almacenid, proveedorid);
